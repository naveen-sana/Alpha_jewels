-- MySQL Schema and Seed Data Script for Alpha Jewels
-- Compatible with local MySQL 8.0 and Aiven MySQL
...
ON DUPLICATE KEY UPDATE name = VALUES(name), category_name = VALUES(category_name);

INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (111, 111, 1, 'Nury Chevron Ring', 'Nury Chevron Ring', 7914.29, 5, 5, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (112, 112, 1, 'The trina ring', 'beautifuly designed Trina', 9642.86, 5, 5, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (113, 113, 1, 'Ozo stud earing', 'Handmade Ozo earrings for women', 7743.29, 7, 7, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (114, 114, 1, 'Nuray earings', 'N-shaped Rings with pure gold', 9287, 7, 7, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (115, 115, 1, 'Mazikeen Necklace', 'Mazi-Queen Royal look Necklace', 12785.71, 6, 6, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (116, 116, 1, 'ryck princess', 'The ryck Princess Necklace', 14285.57, 6, 6, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (117, 117, 1, 'Bracelite', 'The Aelric Bracelet', 9000, 8, 8, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (118, 118, 1, 'resilent Bracelet', 'The Chain-typed Bracelet', 9200, 8, 8, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (119, 119, 1, 'Line Bangles', 'Royal elegent Bangles for women', 9571.43, 4, 4, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (120, 120, 1, 'Set Bangles', 'The Bazel-Set Bangles', 10000, 4, 4, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (121, 121, 2, 'Spiral Ring', 'Classic Spiral Gold Ring', 9000, 6, 6, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (122, 122, 2, 'leaf design Ring', 'Elegant Leaf Design Gold Ring', 6600, 6, 6, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (123, 123, 2, 'Stud Earrings', 'Temple Gold Stud Earrings', 8800, 4, 4, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (124, 124, 2, 'Mahroosh Diamond Necklace', 'Indriya Necklace by Aditya Birla', 9285.71, 8, 8, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (125, 125, 2, 'Lakshmi Temple Necklace', 'Beautifully designed Necklace', 11111, 3, 3, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (126, 126, 2, 'Lakshmi Gold Necklace', 'Wonderfully designed Necklace', 12698.29, 3, 3, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (127, 127, 2, 'Gold Beaded Bracelet', 'Handicrafted Bracelet for Women', 9162.4, 2, 2, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (128, 128, 2, 'Textured Gold Bracelet', 'Men Stylish and elogant look Bracelet', 7712.4, 8, 8, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (131, 131, 3, 'Vidh Platinum Solitire', 'Best Ring for men', 9004.2, 8, 8, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (132, 132, 3, 'Elegant floral Ring', 'Elegant floral Platinum Ring', 9391.57, 8, 8, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (133, 133, 3, 'Swirl Stud Earrings', 'Circular Earrings', 6650.8, 7, 7, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (134, 134, 3, 'Floral Stud Earrings', 'Flower Stud Earrings', 6509.2, 7, 7, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (135, 135, 3, 'Emerald Drop Platinum Necklece', 'Wonderfully Crafted Necklace for Women', 12842.71, 1, 1, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (136, 136, 3, 'Solitaire Platinum Pendant Necklace', 'Looking Gorgeous', 12556.86, 1, 1, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (137, 137, 3, 'Start Motif Platinum Bracelet', 'Start Bracelet', 9353.57, 3, 3, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (138, 138, 3, 'Floral Two-Tone Platinum Bracelet', 'Floral Two-Tone Platinum Bracelet', 8124.86, 3, 3, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (139, 139, 3, 'Start- Motif Platinum Bangles', 'Floral Two-Tone Platinum Bracelet', 9353.86, 4, 4, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (140, 140, 3, 'Eternity Platinum Bangle', 'Premium Bangles', 7807.86, 5, 5, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (141, 141, 4, 'Meris Textured Band Ring', 'Wonderful Silverplated Ring', 6666.4, 8, 8, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (142, 142, 4, 'Butterfly Ring', 'Adjustable silver Butterfly Ring', 4542.4, 8, 8, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (143, 143, 4, 'Dangler Earrings', 'Silver Flower Dangler Earrings', 4917.8, 9, 9, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (144, 144, 4, 'Ossum Earrings', 'Beautiful Eearings for Women', 5517.2, 9, 9, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (145, 145, 4, 'Wisdom Sterling Silver Necklace', 'Infinite Wisdom Sterling Silver Necklace', 9164.2, 4, 4, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (146, 146, 4, 'GargiStone Necklace', 'Beautifully Crafted Stone Necklace', 9305, 4, 4, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (147, 147, 4, 'Flexi Bracelet', 'Fleur Flexi Bracelet in Silver', 7936.29, 3, 3, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (148, 148, 4, 'Chain Bracelet', 'Clara Womens Evil Eye Bracelet', 7048.2, 3, 3, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (149, 149, 4, 'Rewa Bangles', 'Beautiful Rewa Bangles', 8503.2, 4, 4, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (150, 150, 4, 'Sterling Bangles', 'Beautiful Sterling Bangles', 7912.8, 4, 4, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (151, 151, 4, 'Royal Diamond Choker', 'Exquisite Royal Choker', 12000, 3, 3, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (155, 155, 2, 'Neckpice Necklace', 'Beautifully crafted necklace for women', 7886, 10, 10, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (156, 156, 2, 'Long Necklace', 'Antique Gold Necklace for women', 7896, 9, 9, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (157, 157, 2, 'Antique Jumkas', 'Gold Plated One Gram Gold Antique Jhumkas', 5632, 10, 10, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (159, 159, 1, 'Stoned Diamond Necklace', 'Beautiful stoned Necklace for women', 9889, 10, 10, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (160, 160, 1, 'Stoned Ring', 'A Beautiful Diamond Ring Stands in a Store Window', 9563, 10, 10, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (161, 161, 3, 'Rose Gold paltinum Necklace', 'Rose Gold paltinum Necklace', 6548, 10, 10, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (162, 162, 3, 'Square Piece-Set Neckalce', 'Square Piece Step Necklace', 6541, 10, 10, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (163, 163, 4, 'Ghungroo Jwellery Set', 'Ghungroo Studded Filigree Work Silver Plated Antique Jewellery Set', 5469, 10, 10, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
...
INSERT INTO products (id, product_id, category_id, name, description, price, stock, stock_quantity, status) VALUES (164, 164, 4, 'Navaratri Jewellery', 'Silver Necklace, Navratri Jewellery', 4589, 10, 10, 'ACTIVE') ON DUPLICATE KEY UPDATE name = VALUES(name), price = VALUES(price), description = VALUES(description);
