...
public class ProductCartController {
    ...
    @Autowired
    private com.jewellery.service.JwtService jwtService;

    @Autowired(required = false)
    private org.springframework.security.crypto.password.PasswordEncoder passwordEncoder;

    @PostMapping(value = {"/users/login", "/users/login/"}, consumes = {"application/json", "*/*"})
    public ResponseEntity<?> handleUserLogin(@RequestBody(required = false) Map<String, Object> body) {
        try {
